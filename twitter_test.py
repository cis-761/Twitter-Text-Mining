...
if __name__ == '__main__':
    ...
    # OKAY I NEED TO FIGURE OUT HOW I CAN DO BOTH.... IS THAT A THINK? WILL THE API HATE ME? --- CAN I DO THIS... TRACK AND ALSO RESTRICT LOCATION OF TRACK..
    stream.filter(track=['flu', 'flushot'], locations=locations_combined)
